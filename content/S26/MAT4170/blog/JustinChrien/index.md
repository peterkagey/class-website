...
<figure>
  ...
  <figcaption>Cayley Table of $D_3$</figcaption>
</figure>
...
> Given a representation $\\rho : G \\to GL(\\mathbb{R}^n)$, a **subrepresentaion** of $G$ is a subspace $U\\subseteq \\mathbb R^n$ such that $\\rho(g)(U) \\subseteq U$ for all $g\\in G$.
